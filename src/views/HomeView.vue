...
<template>
  ...
  <section class="py-10 flex flex-col lg:flex-row gap-5 px-10 md:px-16 lg:px-32">
    ...
    <cardInfo title="Nuestra Estrategia"
      info="Desarrollamos estrategias para proteger y resguardar a nuestros valiosos clientes, brindándoles tranquilidad y confianza.">
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="white"
        class="w-6 h-w-6">
    ...
    <cardInfo title="Execución de Servicios"
      info="Ejecutamos servicios de seguridad privada con precisión y profesionalismo, siempre buscando la mejor forma de trabajar.">
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="white"
        class="w-6 h-w-6">
        <path stroke-linecap="round" stroke-linejoin="round"
  ...
  <section class="py-10 px-10 lg:px-0 mx-auto container flex flex-col-reverse lg:flex-row justify-center items-center gap-10 text-center lg:text-left">
      <div class="flex flex-col gap-5 w-full lg:w-1/3">
        <h3 class="text-3xl lg:text-4xl font-normal text-gray-600">Tu empresa de <span class="font-black">Seguridad Privada</span></h3>
        <p class="text-gray-500 font-thin text-md">Con más de una década de experiencia en el sector nos enorgullecemos de ser una opción de seguridad privada confiable y dedicada.</p>
        <p class="text-gray-500 font-thin text-md ">Hemos estado comprometidos en salvaguardar lo que más valoras, brindando tranquilidad a nuestros clientes en cada paso del camino. Nuestra trayectoria sólida y exitosa es el reflejo de un equipo altamente capacitado y apasionado por proteger a comunidades, hogares y negocios.</p>
        <button
          class="text-center text-xl lg:text-lg font-bold block bg-secondary mt-5 text-white px-5 py-2 rounded-lg hover:bg-amber-300 transition-colors w-full lg:w-1/3 md:w-2/3 shadow-md mx-auto lg:mx-0">
          Saber más
        </button>
      </div>

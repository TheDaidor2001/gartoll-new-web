...
<template>
    <div role="status" class="flex gap-10 animate-pulse md:space-y-0">
        <div class=" h-96 w-1/2 min-h-max flex items-center justify-center bg-gray-300 rounded">
        ...
        <div class="w-1/2 flex flex-col py-10">
